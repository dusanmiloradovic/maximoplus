  ...
  $.ajax(
    {
      ...
      {
	$("#contact-message").html('<pre><code class="prettyprint">'+data+'</code></pre>');

      },
      error: function(jqXHR, textStatus, errorThrown) 
      {
	$("#contact-message").html('<pre><code class="prettyprint">AJAX Request Failed<br/> textStatus='+textStatus+', errorThrown='+errorThrown+'</code></pre>');
      }
    });
...
$("#dld").click(function(ev){
  $("#hiddow").val("true");
  $("#contact-message").html("Enter your email to receive the download link");
  $("#contactmessage").val("Please send me the link to download the fully functional MaximoPlus platform");
  document.location.hash="#contact-message";
